...
exports.config = {
    ...
    onPrepare: () => {
        protractor_1.browser.executeScript('return !!window.angular');
        protractor_1.browser.ignoreSynchronization = true;
        protractor_1.browser.ignoreUncaughtExceptions = true;
        ...
        var copyRecursiveSync = function (src, dest) {
            ...
            if (exists && isDirectory) {
                ...
                fs.readdirSync(src).forEach(function (childItemName) {
                    fs.copySync(path.join(src, childItemName), path.join(dest, childItemName));
