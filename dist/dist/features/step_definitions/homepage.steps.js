...
cucumber_1.defineSupportCode(function ({ Given, Then, When }) {
    ...
    When('ABP-0010 click on account overview', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//a[@href='https://market2.beta.formed.org/customer/account/']")).click();
        yield delay(10000);
    }));
    ...
    Then('ABP-0050 credit plan details are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='cancel-credit-plan-btn']"))).to.eventually.exist;
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath(".//a[@href='https://market.beta.formed.org/creditplans.html/']")).click();
        yield delay(15000);
    }));
    ...
    When('i move to study products', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.browser.actions().mouseMove(protractor_1.element(protractor_1.by.xpath("//a[@href='https://market2.beta.formed.org/study.html']"))).perform();
        yield delay(5000);
    }));
    When('i move to watch products', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.browser.actions().mouseMove(protractor_1.element(protractor_1.by.xpath("//a[@href='https://market2.beta.formed.org/watch.html']"))).perform();
        yield delay(5000);
    }));
    When('i move to listen products', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.browser.actions().mouseMove(protractor_1.element(protractor_1.by.xpath("//a[@href='https://market2.beta.formed.org/listen.html']"))).perform();
        yield delay(5000);
    }));
    When('i move to read products', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.browser.actions().mouseMove(protractor_1.element(protractor_1.by.xpath("//a[@href='https://market2.beta.formed.org/read.html']"))).perform();
        yield delay(5000);
    }));
    ...
    When('PAP-0010 i navigate to listen and click on audio dramas', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(7000);
        protractor_1.element(protractor_1.by.xpath(".//*[@href='https://market2.beta.formed.org/shop-products/listen/audio-dramas.html']")).click();
        yield delay(20000);
    }));
    ...
    When('PAP-0020 i click on Item', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[3]/ol/li[4]/div/a/img")).click();
        yield delay(15000);
    }));
    Then('PAP-0020 Product details is displayed', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='product__description--toggle']"))).to.eventually.exist;
        yield delay(3000);
    ...
    When('PBP-0060 click on remove option', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='mini-cart']/li[1]/div/div/div[3]/div/a")).click();
        yield delay(15000);
    }));
    ...
    Then('CPS-0020 Get Credit Plan prompt is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("html/body/header/section[1]/div[8]/div/a/span"))).to.eventually.exist;
        yield delay(10000);
        //element(by.xpath("html/body/header/section[1]/div[8]/div/a/span")).isDisplayed();
    }));
    ...
    Then('PBP-0010 click on Read option in digital products', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.browser.actions().mouseMove(protractor_1.element(protractor_1.by.xpath(".//*[@href='https://market2.beta.formed.org/read.html']"))).perform();
        yield delay(5000);
    ...
    When('SPP-0050 click on filter product', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[4]/ol/form/li[2]/a/label/span")).click();
        yield delay(10000);
    }));
    ...
    Then('click on Bible studies link and verify', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market2.beta.formed.org/study/bible-studies.html']")).click();
        yield delay(10000);
    }));
    ...
    Then('click on Talks link and verify', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market2.beta.formed.org/shop-products/watch/talks.html']")).click();
        yield delay(20000);
