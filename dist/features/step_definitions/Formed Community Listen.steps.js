...
cucumber_1.defineSupportCode(function ({ Given, Then, When }) {
    ...
    When('FCF-0020 navigate tocommunity page and Enter parish user name details', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='header']/div/div/div/div/global-nav/ul/li[2]/a")).click();
        yield delay(20000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='simple-dropdown']")).click();
        yield delay(5000);
    ...
    When('FCF-0030 naviagte to listen link and click on audiobooks', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.browser.actions().mouseMove(protractor_1.element(protractor_1.by.xpath("//a[@href='/listen']"))).perform();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='header']/div/div[3]/div/main-nav/ul/li[3]/segmented-menu-item/div/segmented-links/div/div[1]/a")).click();
        yield delay(10000);
    }));
    Then('FCF-0040 click on image in audiobooks', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div[2]/div/segmented-page/div/div[1]/segment/div[2]/div/stripe/div/div/div[2]/div/div/div/div/div[2]/div/a/img"))).to.eventually.exist;
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div[2]/div/segmented-page/div/div[1]/segment/div[2]/div/stripe/div/div/div[2]/div/div/div/div/div[3]/div/a/img")).click();
        yield delay(20000);
    }));
    ...
    When('FCF-0070 Move a feature into the Published', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath("html/body/main/div[1]/div[1]/div/div[2]/div/div/div[2]/custom-content-tab/div/div/div[3]/ul/li[1]/promo-unit-dashboard-wrapper/div/div/div/div/a")).click();
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='header']/div/div/div/div/global-nav/ul/li[2]/a")).click();
        yield delay(20000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='simple-dropdown']/span")).click();
    ...
    Then('FCF-0080 move a published feature into unpublished list', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath("html/body/main/div[1]/div[1]/div/div[2]/div/div/div[2]/custom-content-tab/div/div/div[1]/div[2]/ul/li[1]/promo-unit-dashboard-wrapper/div/div/div/div/a")).click();
        yield delay(10000);
    }));
    Then('FCF-0070 click on Edit feature in unpublish list', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath("html/body/main/div[1]/div[1]/div/div[2]/div/div/div[2]/custom-content-tab/div/div/div[3]/ul/li[1]/promo-unit-dashboard-wrapper/div/div/div/div/div/modal-link/a")).click();
        yield delay(8000);
    }));
    Then('FCF-0070 change the name Title ,text color and click on cencle button', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/name-and-description/div[1]/input")).click();
        yield delay(8000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/name-and-description/div[1]/input")).sendKeys('of mind');
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/name-and-description/div[2]/ng-quill-editor/div/div/div[1]")).click();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/name-and-description/div[2]/ng-quill-editor/div/div/div[1]")).sendKeys('sasicharah');
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/media-position-selector/div/div/div[2]/div[1]/div[1]/div")).click();
        yield delay(8000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/background-color/div/div[2]/ul/li[2]/a")).click();
        yield delay(8000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/div[2]/a")).click();
        yield delay(15000);
    }));
    ...
    Then('FCF-0090 Delete feature', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath("html/body/main/div[1]/div[1]/div/div[2]/div/div/div[2]/custom-content-tab/div/div/div[3]/ul/li[2]/promo-unit-dashboard-wrapper/div/div/div/div/div/a[2]")).click();
        yield delay(8000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div[1]/div[1]/div/div[2]/div/div/div[2]/custom-content-tab/div/div/div[3]/ul/li[2]/promo-unit-dashboard-wrapper/div/div/div/div/div/div/div[2]/div/div/p[2]/a")).click();
        yield delay(8000);
    }));
    ...
    Then('FCF-0130 click on managesessions and create a session using Youtube', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(10000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-group-view/div[1]/div/div[2]/div/manage-sessions-view/form/div[2]/a"))).to.eventually.exist;
        yield delay(2000);
        ...
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-group-view/div[1]/div/div[2]/div/manage-sessions-view/form/name-and-description/div[1]/input")).sendKeys("Formed");
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-group-view/div[1]/div/div[2]/div/manage-sessions-view/form/name-and-description/div[2]/ng-quill-editor/div/div/div[1]")).sendKeys("i love my country");
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-group-view/div[1]/div/div[2]/div/manage-sessions-view/form/media-type-selector/div/div/div[2]/div[1]/div[2]/div")).click();
        yield delay(5000);
    ...
    Then('FCF-0140 create another session', () => __awaiter(this, void 0, void 0, function* () {
        ...
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-group-view/div[1]/div/div[2]/div/manage-sessions-view/form/div[2]/a")).click();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-group-view/div[1]/div/div[2]/div/manage-sessions-view/form/name-and-description/div[1]/input")).sendKeys("Resquest");
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-group-view/div[1]/div/div[2]/div/manage-sessions-view/form/name-and-description/div[2]/ng-quill-editor/div/div/div[1]")).sendKeys("possible things");
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-group-view/div[1]/div/div[2]/div/manage-sessions-view/form/media-type-selector/div/div/div[2]/div[1]/div[2]/div")).click();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-group-view/div[1]/div/div[2]/div/manage-sessions-view/form/media-embed/div[2]/div[2]/div/textarea")).sendKeys('<iframe width="100%" height="300" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/328259811&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe>');
        yield delay(10000);
    }));
    ...
    Then('FCF-0140 click on dropdown from manage sessions', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-group-view/div[2]/button")).click();
        yield delay(15000);
    }));
    Then('FCF-0140 click on oraganize sessions', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-group-view/div[1]/div/div[2]/div/manage-sessions-view/form/span/a")).click();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-group-view/div[1]/ul/li[3]/a/tab-heading/div/h3")).click();
        yield delay(5000);
    }));
    ...
    Then('FCF-0140 create a session using Audio', () => __awaiter(this, void 0, void 0, function* () {
        ...
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-group-view/div[1]/div/div[2]/div/manage-sessions-view/form/name-and-description/div[2]/ng-quill-editor/div/div/div[1]")).sendKeys("possible things");
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-group-view/div[1]/div/div[2]/div/manage-sessions-view/form/media-type-selector/div/div/div[2]/div[1]/div[3]/div")).click();
        yield delay(5000);
    ...
    Then('FCF-0170 Click on visit group and click on group roster', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div/div[3]/div[2]/custom-content-wrapper/div/div/div/promo-unit/div/div[2]/div/div[1]/div/a/img")).click();
        yield delay(10000);
    ...
    Then('FCF-0190 click on Comments and write newcomment', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='content']/div/div/div[4]/div[2]/div/div/ul/li/div[2]/div[2]/div/div/a")).click();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='content']/div/div[2]/div[2]/header/div/ul/li[4]/div/button[1]")).click();
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='composer']/div/div[2]/div/div[1]/div[2]/div/div/textarea")).sendKeys('it is good');
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='composer']/div/div[2]/div/div[1]/div[2]/div/ul/li[1]/button")).click();
        yield delay(10000);
    }));
    Then('FCF-0200 likes and replay buttons are dispalyed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='content']/div/div[2]/div[2]/div/div/div/div[1]/article/div/aside/ul/li[1]/button"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='content']/div/div[2]/div[2]/div/div/div/div[1]/article/div/aside/ul/li[2]/button"))).to.eventually.exist;
        yield delay(2000);
    }));
    When('FCF-0210 click on likes and replay buttons', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='content']/div/div[2]/div[2]/div/div/div/div[1]/article/div/aside/ul/li[1]/button")).click();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='content']/div/div[2]/div[2]/div/div/div/div[1]/article/div/aside/ul/li[2]/button")).click();
        yield delay(5000);
    }));
    When('FCF-0210 enter the text in replay textarea', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='composer']/div/div[2]/div/div[1]/div[2]/div/div")).sendKeys('Thank you');
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='composer']/div/div[2]/div/div[1]/div[2]/div/ul/li[1]/button")).click();
        yield delay(5000);
    }));
    ...
    When('FCF-0290 delete the Comments', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='content']/div/div[2]/div[2]/div/div/div/div[1]/article/div/aside/ul/li[3]/div/button")).click();
        yield delay(15000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='content']/div/div[2]/div[2]/div/div/div/div[1]/article/div/aside/ul/li[3]/div/ul/li[3]/button")).click();
        yield delay(10000);
    }));
    Then('FCF-0220 click on Edit comment button', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='content']/div/div[2]/div[2]/header/div/ul/li[3]/button")).click();
        yield delay(5000);
    }));
    ...
    Then('FCF-0230 click on Return to the session and delete the comments', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='content']/div/a")).click();
        yield delay(5000);
        ...
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='content']/div/div/div[4]/div[2]/div/div/ul/li/div[2]/div[2]/div/div/div/ul/li[3]/button")).click();
        yield delay(10000);
    }));
    ...
    When('FCF-0260 Click on username drop down for parish user but northing published', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='simple-dropdown']")).click();
        yield delay(2000);
    ...
    Then('click on logout button from parish user but northing published', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='simple-dropdown']/span")).click();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='header']/div/div[1]/div/div/ul/profile-menu/div/div/div/div/div[2]/a[3]")).click();
        yield delay(10000);
    ...
    Then('FCF-0100 naviagte to read link and click on Nonfiction', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(10000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/segmented-page/div/div[1]/segment/div[2]/div/stripe/div/div/div[2]/div/div/div/div/div[12]/div/a/img"))).to.eventually.exist;
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='scroll-top']/div/segmented-page/div/div[1]/segment/div[2]/div/stripe/div/div/div[2]/div/div/div/div/div[12]/div/a/img")).click();
        yield delay(20000);
    }));
    ...
    Then('FCF-0260 Feature Editor is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/name-and-description/div[1]/input"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/media-type-selector/div/div/div[2]/div[1]/div[2]/div"))).to.eventually.exist;
        yield delay(2000);
    }));
    When('FCF-0260 create a feature using a Youtube embed code', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/name-and-description/div[1]/input")).sendKeys("youtube");
        yield delay(8000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/name-and-description/div[2]/ng-quill-editor/div/div/div[1]")).click();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/name-and-description/div[2]/ng-quill-editor/div/div/div[1]")).sendKeys("youtubecode");
        yield delay(8000);
        ...
        yield delay(8000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/media-embed/div[2]/div[2]/div/textarea")).sendKeys('<iframe width="560" height="315" src="https://www.youtube.com/embed/d57hAb9FJoE" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>');
        yield delay(8000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/input")).click();
        yield delay(15000);
    }));
    When('FCF-0270 create a feature using a vimeo code', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/name-and-description/div[1]/input")).sendKeys("Vimeo");
        yield delay(8000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/name-and-description/div[2]/ng-quill-editor/div/div/div[1]")).click();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/name-and-description/div[2]/ng-quill-editor/div/div/div[1]")).sendKeys("vimeocode");
        yield delay(8000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/media-type-selector/div/div/div[2]/div[1]/div[2]/div")).click();
        yield delay(8000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/media-embed/div[2]/div[2]/div/textarea")).sendKeys('<iframe src="https://player.vimeo.com/video/76979871?embedparameter=value" width="640" height="360" frameborder="0" allowfullscreen></iframe>');
        yield delay(8000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/input")).click();
        yield delay(15000);
    }));
    When('FCF-0280 create a feature using a Soundcloud embed code', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/name-and-description/div[1]/input")).sendKeys("Soundcloudembed");
        yield delay(8000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/name-and-description/div[2]/ng-quill-editor/div/div/div[1]")).click();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/name-and-description/div[2]/ng-quill-editor/div/div/div[1]")).sendKeys("Soundcloud embed code");
        yield delay(8000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/media-type-selector/div/div/div[2]/div[1]/div[3]/div")).click();
        yield delay(8000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/media-embed/div[3]/div[2]/div/textarea")).sendKeys('<iframe width="100%" height="300" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/328259811&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe>');
        yield delay(8000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/promo-unit-modal/div[3]/create-feature-view/form/input")).click();
        yield delay(15000);
    }));
    Then('FCF-280 parish admin community page is dispalyed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div/div[3]/div[1]/organization-header/div/div[3]/div/div/a"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div/div[3]/div[2]/custom-content-wrapper/div/div/div[1]/promo-unit/div/div/div/div[1]/div/a/img"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div/div[3]/div[1]/organization-header/div/div[3]/div/div/share/ul/li[1]/a"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div/div[3]/div[1]/organization-header/div/div[3]/div/div/share/ul/li[2]/a"))).to.eventually.exist;
...
//# sourceMappingURL=Formed Community Listen.steps.js.map