...
cucumber_1.defineSupportCode(function ({ Given, Then, When }) {
    ...
    Then('FFC-0310 click on Formed Contribution Account page and Edit the payment method', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(15000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='account-nav']/ul/li[11]/a")).click();
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[3]/div[1]/div/div[2]/div[3]/span[2]/a")).click();
        yield delay(10000);
    }));
    Then('FFC-0310 change the Monthly amount', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(15000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='md_savecard']/option[1]")).click();
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='subscription_profile_update']/div/div[2]/div/p/a")).click();
        yield delay(2000);
    }));
    Then('FFC-0330 change the Contribution amount', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(15000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='change_recurring_amount_input']")).click();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='change_recurring_amount_input']")).sendKeys('1');
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@class='change-recurring-amount-btn']")).click();
        yield delay(15000);
    }));
    When('FFC-0330 click on Edit button in Monthly Recurring Amount', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(15000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='change_recurring_amount']"))).to.eventually.exist;
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='change_recurring_amount']")).click();
        yield delay(2000);
    }));
    ...
    Then('FFC-0330 changed Contribution amount is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div[2]/div[1]/div/div")).getText()).to.eventually.equal('Recurring contribution amount successfully changed from $100.00 to $1,010.00.');
        yield delay(10000);
    }));
    Then('ABP-0010 plan details are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/creditplans.html/']"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//a[@href='https://market.beta.formed.org/customer/account/']"))).to.eventually.exist;
        yield delay(3000);
    ...
    When('ABP-0020 click on login settings', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//a[@href='https://market.beta.formed.org/customer/account/edit/']")).click();
        yield delay(15000);
    }));
    ...
    When('ABP-0030 click on payment method', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/magedelight_cybersource/cards/listing/']")).click();
        yield delay(15000);
    }));
    ...
    When('ABP-0050 click on credit plan', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/rewards/account/']")).click();
        yield delay(10000);
    }));
    ...
    When('ABP-0060 click on your orders', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/sales/order/history/']")).click();
        yield delay(10000);
    }));
    ...
    Then('ABP-0070 View details is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@class='order-number']"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@class='order-date']"))).to.eventually.exist;
        yield delay(3000);
    }));
    ...
    When('i move to shops products', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.browser.actions().mouseMove(protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products.html']"))).perform();
        yield delay(5000);
    }));
    ...
    When('i move to subscription products', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.browser.actions().mouseMove(protractor_1.element(protractor_1.by.linkText("Subscriptions"))).perform();
        yield delay(5000);
    }));
    When('PAP-0010 click on Talks', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(7000);
        protractor_1.element(protractor_1.by.xpath(".//*[@href='https://market.beta.formed.org/shop-products/listen/talks.html']")).click();
        yield delay(20000);
    }));
    ...
    When('Click on Product in Audio Books', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[3]/ol/li[1]/div/a")).click();
        yield delay(20000);
    }));
    ...
    Then('PBP-0070 Verify the Checkout Page', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(30000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div[1]/div[4]/div[1]/div[6]/button"))).to.eventually.exist;
        yield delay(10000);
    }));
    ...
    Then('PBP-0070 Order Confirmation is displayed', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(10000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/header/h1"))).to.eventually.exist;
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div[1]/div[4]/div[1]/div[6]/button")).click();
        yield delay(10000);
    ...
    Then('Click on Product2 in Talks', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(15000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[3]/ol/li[1]/div/a/img")).click();
        yield delay(10000);
    }));
    Then('CO-0010 Verify Check Out in Cart', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='mini-cart']/li[1]/div/div/strong[1]/a"))).to.eventually.exist;
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='mini-cart']/li[1]/div/div/strong[1]/a")).click();
        yield delay(10000);
    }));
    ...
    When('PBC-0040 click on Entercupon', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(8000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='discount-code']"))).to.eventually.exist;
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='discount-code']")).sendKeys('testgas');
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='discount-form']/div/div[2]/div/button")).click();
        yield delay(10000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='opc-sidebar']/div[1]/div[2]/div[2]/div[1]/div/div/div/div/div")).getText()).to.eventually.equal('Your coupon was successfully applied.');
        yield delay(5000);
    }));
    Then('PBC-0100 TOTAL amount is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield hooks_1.expect(protractor_1.element(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div[2]/div[1]/div/div[9]/div[2]/strong/span")).getText()).to.eventually.equal("$625.00");
        yield delay(10000);
    }));
    Then('CO-0040 Create Account and Continue login is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='checkout-step-billing']/p/a"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@href='/customer/account/create?onSuccess=onestepcheckout']"))).to.eventually.exist;
        yield delay(5000);
    }));
    Then('PBC-0020 Enter Purchase Order', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='checkout-payment-method-load']/div/div[2]/div[3]/div[2]/div[1]/div/input")).sendKeys("test");
        yield delay(5000);
    }));
    ...
    When('VR-0020 Click on the create an account', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@href='/customer/account/create?onSuccess=onestepcheckout']"))).to.eventually.exist;
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath(".//*[@href='/customer/account/create?onSuccess=onestepcheckout']")).click();
        yield delay(10000);
    }));
    ...
    Then('click on watch Feature Films product', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
    ...
    When('click on credits', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[1]/ul/li[3]/form/button"))).to.eventually.exist;
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[1]/ul/li[3]/form/button")).click();
        yield delay(15000);
        protractor_1.element(protractor_1.by.xpath(".//*[@class='counter qty']")).click();
        yield delay(8000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='top-cart-btn-checkout']")).click();
    ...
    Then('CPS-0100 Click on Change credit plan', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath(".//*[@href='https://market.beta.formed.org/creditplans.html/']")).click();
        yield delay(6000);
    }));
    ...
    Then('click on watch Documentreies product1', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[3]/ol/li[9]/div/a/img")).click();
        yield delay(25000);
    }));
    Then('CO-0100 Click on Apply credits', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(6000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='checkout-review-table']/tbody/tr[1]/td[2]/div/div/div[3]/label/span")).click();
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='checkout-review-table']/tbody/tr[2]/td[2]/div/div/div[3]/label/span")).click();
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='checkout-review-table']/tbody/tr[2]/td[2]/div/div/div[3]/span"))).to.eventually.exist;
        yield delay(1000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='checkout-review-table']/tbody/tr[2]/td[2]/div/div/div[4]/button"))).to.eventually.exist;
        yield delay(1000);
    }));
    Then('FFC-0020 Navigate to community page', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(15000);
        protractor_1.element(protractor_1.by.xpath(".//*[@href='/community']")).click();
        yield delay(20000);
    }));
    Then('FFC-0030 Formed Funding goal is displayed and click on Contribute button', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(15000);
        protractor_1.element(protractor_1.by.xpath(".//*[@class='btn btn-inverted btn-large']")).click();
        yield delay(20000);
    }));
    Then('FFC-0280 click on monthly and Contribution is entered', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='product-options-wrapper']/div/div[1]/div[2]/div/label/span")).click();
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='product-options-wrapper']/div/div[2]/input")).click();
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='product-options-wrapper']/div/div[2]/input")).sendKeys('100');
        yield delay(10000);
    }));
    When('FFC-0340 Formed funding Account prompt is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(15000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("html/body/div[3]/aside[1]/div[2]/footer/button"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='has-recurring-modal']/p"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('FFC-0340 click on Go To Account page', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[3]/aside[1]/div[2]/footer")).click();
        yield delay(15000);
    }));
    Then('FFC-0280 click on Next button', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='product-addtocart-button']"))).to.eventually.exist;
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='product-addtocart-button']")).click();
    ...
    Then('FFC-0280 Next button is enable and click on Next button', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='product-addtocart-button']"))).to.eventually.exist;
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='product-addtocart-button']")).click();
        yield delay(20000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='checkout-step-billing']/div[1]/div/select")).click();
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='checkout-step-billing']/div[1]/div/select/option[2]")).click();
        yield delay(5000);
    }));
    Then('FFC-0290 Enter Billing information', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(15000);
        protractor_1.element(protractor_1.by.xpath('html/body/main/div/main/div/div/div[3]/div[3]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[2]/form/fieldset/fieldset/div/div[1]/div/input')).sendKeys('chicago illunious');
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div/div/div[3]/div[3]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[2]/form/fieldset/div[3]/div/input")).sendKeys('chicago');
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div/div/div[3]/div[3]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[2]/form/fieldset/div[5]/div/select")).click();
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div/div/div[3]/div[3]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[2]/form/fieldset/div[5]/div/select/option[13]")).click();
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div/div/div[3]/div[3]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[2]/form/fieldset/div[6]/div/input")).sendKeys('60014');
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='magedelight_cybersource_payment_profile_id']")).click();
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='magedelight_cybersource_payment_profile_id']/option[2]")).click();
        yield delay(10000);
    }));
    When('FFC-0290 Enter payment method', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='magedelight_cybersource_cc_type']/option[3]")).click();
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='magedelight_cybersource_cc_number']")).sendKeys('4242424242424242');
        yield delay(10000);
    ...
    Then('FFC-0300 Order conformation page is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div/div[2]/strong/span"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div/div[2]/strong"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div/div[3]/dl/dd[2]"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('FFC-0040 Formed Funding Campaign page is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='product-options-wrapper']/div/div[1]/div[1]/div/label/span"))).to.eventually.exist;
        yield delay(1000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[4]/div[3]/div/div[1]/span"))).to.eventually.exist;
        yield delay(1000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='product-options-wrapper']/div/div[2]/input")).click();
        yield delay(8000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='product-options-wrapper']/div/div[2]/input")).sendKeys('50');
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='product-addtocart-button']")).click();
        yield delay(20000);
    }));
    When('FFC-0050 Enter the credit card Cvv number', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='formed-funding-info__graph']"))).to.eventually.exist;
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='magedelight_cybersource_cc_cid']")).sendKeys('123');
        yield delay(15000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='checkout-step-payment']/div/div[3]/div/button")).click();
    ...
    Then('FFC-0060 Conformation Contribution is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div/div[2]/strong/span")).getText()).to.eventually.equal('$50.00');
        yield delay(10000);
    }));
    Then('FFC-0070 click on View button in Account page', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield hooks_1.expect(protractor_1.element(protractor_1.by.xpath(".//*[@id='my-orders-table']/tbody/tr[1]/td[4]/span")).getText()).to.eventually.equal('$50.00');
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@href='https://beta.formed.org/']")).click();
        yield delay(15000);
    }));
    Then('FFC-0080 order Details is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.element(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div[1]/div[3]/div[2]/div[1]/div[1]/div[5]/div[2]/strong/span")).getText()).to.eventually.equal('$50.00');
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@href='https://beta.formed.org/']")).click();
        yield delay(15000);
    }));
    When('FFC-0090 Formed Funnding Contribution is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='header']/div/div[3]/div/crowd-funding-widget/div/div/div[1]/a"))).to.eventually.exist;
        yield delay(5000);
    }));
    Then('CO-0100 click on apply credits', () => __awaiter(this, void 0, void 0, function* () {
    ...
    Then('HPF-0020 market details are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@href='https://market.beta.formed.org/all-products/study.html']"))).to.eventually.exist;
        yield delay(3000);
    ...
    When('HPF-0020 move to Study products', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.browser.actions().mouseMove(protractor_1.element(protractor_1.by.linkText("Study"))).perform();
        yield delay(5000);
    ...
    When('HPF-0020 move to Watch products', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.browser.actions().mouseMove(protractor_1.element(protractor_1.by.linkText("Watch"))).perform();
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/watch/feature-films.html']"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/watch/documentaries.html']"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/watch/tv-shows.html']"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/watch/talks.html']"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/watch/spanish.html']"))).to.eventually.exist;
        yield delay(2000);
    }));
    When('HPF-0020 move to Subscriptions', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.browser.actions().mouseMove(protractor_1.element(protractor_1.by.linkText("Subscriptions"))).perform();
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/formed-subscriptions/on-demand.html']"))).to.eventually.exist;
        yield delay(2000);
    }));
    When('HPF-0020 move to Read products', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.browser.actions().mouseMove(protractor_1.element(protractor_1.by.linkText("Read"))).perform();
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/read/nonfiction.html']"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/read/fiction.html']"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/read/youth.html']"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/read/espa-ol.html']"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('HPF-0020 products page is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
    ...
    When('Click on Start Shopping in Library page', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(20000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/section/a")).click();
        yield delay(15000);
    }));
    When('HPF-0080 purchase products is displayed', () => __awaiter(this, void 0, void 0, function* () {
    ...
    When('HPF-0020 move to Listen products', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.browser.actions().mouseMove(protractor_1.element(protractor_1.by.linkText("Listen"))).perform();
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/listen/talks.html']"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/listen/audio-dramas.html']"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/listen/audiobooks.html']"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/listen/espa-ol.html']"))).to.eventually.exist;
        yield delay(2000);
    }));
    ...
    When('HPF-0050 i click on library link', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(20000);
        protractor_1.element(protractor_1.by.xpath(".//a[@href='https://market.beta.formed.org/mylibrary/']']")).click();
        yield delay(15000);
    }));
    ...
    Then('HPF-0070 login user market page details', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@href='https://market.beta.formed.org/shop-products.html']"))).to.eventually.exist;
        yield delay(3000);
    ...
    When('LP-0050 click on watch', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li/a/label/div[1]")).click();
        yield delay(10000);
    }));
    Then('LP-0050 watch purchased products are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[4]/div/ol/li[1]/div/div/a/img"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li/ol/li[1]/a/label/div[1]"))).to.eventually.exist;
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[4]/div/ol/li[1]/div/div/div[2]/strong/a"))).to.eventually.exist;
        yield delay(3000);
    ...
    Then('LP-0060 click on play button', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='player-view']/resumeable-player/div[2]/div/div[1]/div[2]/a/i")).click();
        yield delay(5000);
    ...
    When('LP-0070 click on Listen', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.linkText("Listen"))).to.eventually.exist;
        protractor_1.element(protractor_1.by.linkText("Listen")).click();
        yield delay(10000);
    }));
    When('LP-0070 Listen purchased products are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[4]/div/ol/li/div/div/a/img"))).to.eventually.exist;
        yield delay(3000);
    ...
    When('LP-0040 click on Title string', () => __awaiter(this, void 0, void 0, function* () {
    ...
    When('LP-0080 Read products are displayed', () => __awaiter(this, void 0, void 0, function* () {
    ...
    When('LP-0090 Click on download icon', () => __awaiter(this, void 0, void 0, function* () {
    ...
    Then('LLP-0010 Formed icon, Ondemand, Library, Market are displayed', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@href='https://market.beta.formed.org/mylibrary/']"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@href='https://market.beta.formed.org/']"))).to.eventually.exist;
        yield delay(3000);
    }));
    ...
    When('LLP-0050 Click on account drop down for parish user', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='gigya-login-screen']/form/div/div[1]/div[1]/input")).sendKeys("yogirpatel@gmail.com");
        yield delay(1000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='gigya-login-screen']/form/div/div[1]/div[2]/input")).sendKeys("zoro2017");
        yield delay(1000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='gigya-login-screen']/form/div/div[2]/div/input[1]")).click();
        yield delay(15000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='account-dropdown-button']")).click();
    ...
    Then('LLP-0060 Name and Email are displayed', () => __awaiter(this, void 0, void 0, function* () {
    ...
    Then('LLP-0050 Account, subscription, dashboard, logout are displayed', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='account-dropdown']/div/a[5]"))).to.eventually.exist;
        yield delay(2000);
    }));
    ...
    Then('LLP-0080 Subscription, Parish, Payment information are displayed', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div/div/div/div/div/div[2]/div/div[1]/span"))).to.eventually.exist;
        yield delay(2000);
    }));
    ...
    Then('LLP-0050 Account, Subscription, logout are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='header']/div/div[1]/div/div/ul/profile-menu/div/div/div/div/div[2]/a[1]"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='header']/div/div[1]/div/div/ul/profile-menu/div/div/div/div/div[2]/a[2]"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='header']/div/div[1]/div/div/ul/profile-menu/div/div/div/div/div[2]/span/a"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='header']/div/div[1]/div/div/ul/profile-menu/div/div/div/div/div[2]/a[3]"))).to.eventually.exist;
        yield delay(2000);
    }));
    ...
    Then('click on ondemand subscription', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/formed-subscriptions/on-demand.html']")).click();
        yield delay(15000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[3]/ol/li[1]/div/a/img")).click();
        yield delay(8000);
    }));
    ...
    Then('Billing amount shows in Account overview page and Ondemand subpanel', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(15000);
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/formed/account/']")).click();
        yield delay(10000);
        yield hooks_1.expect(protractor_1.element(protractor_1.by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[3]/div[1]/div[1]/div/div[3]/span[2]")).getText()).to.eventually.equal('$625.00');
        yield delay(5000);
        yield hooks_1.expect(protractor_1.element(protractor_1.by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[1]/div[4]/p[1]")).getText()).to.eventually.equal('$625.00');
        yield delay(5000);
    }));
    Then('PBC-0120 click on account page in user dropdown', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='account-dropdown-button']")).click();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='account-dropdown']/div/a[1]")).click();
    ...
    Then('VR-0010 entercode,getfreetrail,sign up group is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(10000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div/div[2]/div[2]/registration-column/a"))).to.eventually.exist;
        yield delay(5000);
        ...
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div/div[2]/div[4]/registration-column/modal-link/a/span"))).to.eventually.exist;
        yield delay(10000);
    }));
    When('VR-0010 click on Sign up group', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div/div[2]/div[3]/registration-column/a")).click();
        yield delay(10000);
    }));
    ...
    Then('SGB-0010 Enter Payment Method with Form fund', () => __awaiter(this, void 0, void 0, function* () {
        ...
        protractor_1.element(protractor_1.by.xpath(".//*[@id='magedelight_cybersource_cc_cid']")).sendKeys("123");
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='checkout-step-payment']/div/div[2]/div/label/span")).click();
        yield delay(4000);
    }));
    Then('SGB-0020 agree for terms of Funding', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(8000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("html/body/div[3]/aside[2]/div[2]/footer/button[1]"))).to.eventually.exist;
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[3]/aside[2]/div[2]/footer/button[1]")).click();
        yield delay(10000);
    }));
    Then('SGB-0020 Set goal', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("html/body/div[3]/aside[1]/div[2]/footer/button[1]"))).to.eventually.exist;
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[3]/aside[1]/div[2]/footer/button[1]")).click();
        yield delay(3000);
    }));
    Then('VR-0040 Place Order button is displayed and click on place order button', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='checkout-step-review']/div[2]/div/button"))).to.eventually.exist;
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='checkout-step-review']/div[2]/div/button")).click();
        yield delay(30000);
    }));
    When('SGB-0020 Click on Continue to Organisation', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='checkout-step-payment']/div/div[3]/div/button")).click();
        yield delay(10000);
    }));
    When('click on Talks', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/listen/talks.html']")).click();
        yield delay(10000);
    }));
    Then('SGB-0030 summary Page is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(10000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div/div[2]/button"))).to.eventually.exist;
        yield delay(10000);
    ...
    Then('SGB-0040 Click on Setup group and verify', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div/div[2]/button")).click();
        yield delay(20000);
        //.//*[@id='maincontent']/div[2]/div/div[3]/div/div[2]/button
    }));
    Then('SGB-0050 Enter Organisation information is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(40000);
        yield protractor_1.element(protractor_1.by.xpath(".//*[@id='groupLeader']")).click();
        //await delay(2000);
        yield protractor_1.element(protractor_1.by.xpath(".//*[@id='groupLeader']")).sendKeys("Group loeade");
        yield delay(2000);
        yield protractor_1.element(protractor_1.by.xpath(".//*[@id='groupMission']")).sendKeys("Group Mission");
        yield delay(2000);
        yield protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/group-finish-init/div[2]/div[1]/div[2]/form/input[3]")).sendKeys("test");
        yield delay(2000);
        yield protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/group-finish-init/div[2]/div[1]/div[2]/form/custom-url/div/div/div[1]/input")).sendKeys("test");
        yield delay(2000);
        yield protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/group-finish-init/div[2]/div[1]/div[2]/form/input[4]")).click();
        yield delay(2000);
        //.//*[@id='maincontent']/div[2]/div/div[3]/div/div[2]/button
    }));
    ...
    When('VR-0050 click on Entercupon', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(8000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='discount-code']"))).to.eventually.exist;
        yield delay(2000);
    }));
    ...
    When('VR-0030 Choose organization', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='group-subscription-organization']/div[4]/div/button")).click();
        yield delay(15000);
    }));
    ...
    When('VR-0060 Enter organization information', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.browser.navigate().refresh();
        yield delay(30000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='groupLeader']")).sendKeys("KSCR");
        yield delay(2000);
    ...
    Then('VR-0070 Subscription information is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(10000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div/div[1]/div/div/div/div[3]/div[2]/modal-link/a/span"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div/div[1]/div/div/div/div[1]/div[2]/a"))).to.eventually.exist;
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='simple-dropdown']")).click();
        yield delay(4000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='header']/div/div[1]/div/div/ul/profile-menu/div/div/div/div/div[2]/a[3]")).click();
    ...
    Then('PBP-0010 Click on fiction in Read link', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/read/fiction.html']")).click();
        yield delay(15000);
    }));
    ...
    Then('SPP-0010 digital products and search icon are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='search_mini_form']/div[1]/div/label/span[1]"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@href='https://market.beta.formed.org/listen.html']"))).to.eventually.exist;
        yield delay(3000);
    }));
    ...
    When('SPP-0040 click on watch in left side view', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='filters-container']/li/ol/li[2]/a/label/div")).click();
        yield delay(15000);
    }));
    Then('SPP-0040 Watch sub options are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='filters-container']/li/ol/li[2]/ol/li[1]/a/label/div"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='filters-container']/li/ol/li[2]/ol/li[2]/a/label/div"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='filters-container']/li/ol/li[2]/ol/li[3]/a/label/div"))).to.eventually.exist;
        yield delay(3000);
    }));
    When('SPP-0040 click on Listen in left side view', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='filters-container']/li/ol/li[3]/a/label/div")).click();
        yield delay(15000);
    }));
    Then('SPP-0040 Listen sub options are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='filters-container']/li/ol/li[3]/ol/li[1]/a/label/div"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='filters-container']/li/ol/li[3]/ol/li[2]/a/label/div"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='filters-container']/li/ol/li[3]/ol/li[3]/a/label/div"))).to.eventually.exist;
        yield delay(3000);
    }));
    When('SPP-0040 click on Read in left side view', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='filters-container']/li/ol/li[4]/a/label/div")).click();
        yield delay(15000);
    }));
    Then('SPP-0040 Read sub options are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='filters-container']/li/ol/li[4]/ol/li[1]/a/label"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='filters-container']/li/ol/li[4]/ol/li[2]/a/label"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='filters-container']/li/ol/li[4]/ol/li[3]/a/label"))).to.eventually.exist;
        yield delay(3000);
    }));
    When('SPP-0040 select one or more attribute filter', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[3]/ol/form/li[1]/a/label/span")).click();
        yield delay(15000);
    }));
    ...
    Then('SPP-0050 Product details are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[1]/ol/li[1]/div/div/strong/a"))).to.eventually.exist;
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[1]/ol/li[1]/div/div/strong/a")).click();
        yield delay(10000);
    }));
    ...
    Then('navigate to lenlet_cart', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield protractor_1.browser.get("https://market.beta.formed.org/c/lenten_trial");
        yield delay(15000);
    }));
    Then('navigate to getbronze', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield protractor_1.browser.get("https://market.beta.formed.org/c/getbronze");
        yield delay(15000);
    }));
    Then('navigate to 7daytrial', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield protractor_1.browser.get("https://market.beta.formed.org/c/7daytrial");
        yield delay(15000);
    }));
    Then('navigate to SoG', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield protractor_1.browser.get("https://market.beta.formed.org/c/SoG");
        yield delay(15000);
    }));
    Then('navigate to BiaY', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield protractor_1.browser.get("https://market.beta.formed.org/c/BiaY");
        yield delay(15000);
    }));
    Then('navigate to getsilver', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield protractor_1.browser.get("https://market.beta.formed.org/c/getsilver");
        yield delay(15000);
    }));
    Then('navigate to getplatinum', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield protractor_1.browser.get("https://market.beta.formed.org/c/getplatinum");
        yield delay(15000);
    }));
    Then('navigate to getgold', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield protractor_1.browser.get("https://market.beta.formed.org/c/getgold");
        yield delay(15000);
    }));
    ...
    Then('ICO-0030 order conformation is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div[2]/div[4]/div[1]/div[5]/button"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div[2]/div[1]/div/div[1]/strong"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('ICO-0020 Billing information are displayed in incart', () => __awaiter(this, void 0, void 0, function* () {
        ...
        protractor_1.browser.navigate().refresh();
        yield delay(20000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div/div/div[3]/div[4]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[1]/form/fieldset/fieldset/div/div[1]/div/input")).sendKeys("Chicago illonois");
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div/div/div[3]/div[4]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[1]/form/fieldset/div[3]/div/input")).sendKeys("Chicago");
        yield delay(1000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div/div/div[3]/div[4]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[1]/form/fieldset/div[5]/div/select")).click();
        yield delay(1000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div/div/div[3]/div[4]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[1]/form/fieldset/div[5]/div/select/option[13]")).click();
        yield delay(1000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div/div/div[3]/div[4]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[1]/form/fieldset/div[6]/div/input")).sendKeys("60014");
        yield delay(8000);
    }));
    Then('Trail Billing information are displayed in incart', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(20000);
        protractor_1.browser.navigate().refresh();
        yield delay(20000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div/div/div[3]/div[5]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[1]/form/fieldset/fieldset/div/div[1]/div/input")).sendKeys("Chicago illonois");
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div/div/div[3]/div[5]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[1]/form/fieldset/div[3]/div/input")).sendKeys("Chicago");
        yield delay(1000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div/div/div[3]/div[5]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[1]/form/fieldset/div[5]/div/select")).click();
        yield delay(1000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div/div/div[3]/div[5]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[1]/form/fieldset/div[5]/div/select/option[13]")).click();
        yield delay(1000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div/div/div[3]/div[5]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[1]/form/fieldset/div[6]/div/input")).sendKeys("60014");
        yield delay(8000);
    }));
    Then('getbronze order conformation is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(10000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div[2]/div[1]/h2"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div[2]/div[4]/div[3]/div[6]/button"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@class='counter amount']"))).to.eventually.exist;
        yield delay(2000);
    }));
    ...
    Then('BiaY order conformation is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@title='View In My Library']"))).to.eventually.exist; //
        yield delay(2000);
    ...
    Then('LPA-0030 Click on sacramental-preparation and Verify with parish admin', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(10000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/segmented-page/div/div[2]/segment/div[2]/div/stripe/div/div/div[1]/div[1]/h3"))).to.eventually.exist;
        yield delay(3000);
    ...
    Then('LPA-0030 Click on Faith Information and Verify with parish admin', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(10000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.linkText("Augustine Institute Originals"))).to.eventually.exist;
        yield delay(3000);
    }));
    ...
    Then('LPA-0030 Click on Current Topics and Verify with parish admin', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(10000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/segmented-page/div/div[3]/segment/div[2]/div/stripe/div/div/div[1]/div[1]/h3"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/segmented-page/div/div[3]/segment/div[2]/div/stripe/div/div/div[2]/div/div/div/div/div[5]/div/a/img"))).to.eventually.exist;
        yield delay(3000);
    }));
    Then('LPA-0030 Click on Youth Disciple and Verify with parish admin', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(6000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/segmented-page/div/div[4]/segment/div[2]/div/stripe/div/div/div[1]/div[1]/h3"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/segmented-page/div/div[4]/segment/div[2]/div/stripe/div/div/div[2]/div/div/div/div/div[2]/div/a/img"))).to.eventually.exist;
        yield delay(3000);
    }));
    Then('LPA-0030 Click on espanol and Verify with parish admin', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(6000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/segmented-page/div/div[5]/segment/div[2]/div/stripe/div/div/div[1]/div[1]/h3"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/segmented-page/div/div[5]/segment/div[2]/div/stripe/div/div/div[2]/div/div/div/div/div[5]/div/a/img"))).to.eventually.exist;
        yield delay(3000);
    }));
    ...
    Then('LPA-0040 Click on Watch Movies and Verify with parish admin', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/segmented-page/div/div[1]/segment/div[3]/div/stripe/div/div/div[2]/div/div/div/div/div[5]/div/a/img"))).to.eventually.exist;
        yield delay(3000);
    }));
    Then('LPA-0040 Click on Documentaries and Verify with parish admin', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/segmented-page/div/div[2]/segment/div[2]/div/stripe/div/div/div[1]/div[1]/h3"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/segmented-page/div/div[2]/segment/div[2]/div/stripe/div/div/div[2]/div/div/div/div/div[5]/div/a/img"))).to.eventually.exist;
        yield delay(3000);
    }));
    ...
    Then('LPA-0040 Click on Watch Youth Disciple and Verify with parish admin', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/segmented-page/div/div[4]/segment/div[2]/div/stripe/div/div/div[1]/div[1]/h3"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/segmented-page/div/div[4]/segment/div[2]/div/stripe/div/div/div[2]/div/div/div/div/div[5]/div/a/img"))).to.eventually.exist;
        yield delay(3000);
    }));
    ...
    Then('LPA-0050 Click on Listen Talks and Verify with parish admin', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='header']/div/div[3]/div/main-nav/ul/li[3]/segmented-menu-item/div/segmented-links/div/div[3]/a")).click();
        yield delay(10000);
    }));
    Then('LPA-0050 Click on Listen audio dramas and Verify with parish admin', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath("//a[@href='/listen?linkId=listen-dramas']")).click();
        yield delay(6000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div[2]/div/segmented-page/div/div[1]/segment/div[2]/div/stripe/div/div/div[1]/div[1]/h3"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div[2]/div/segmented-page/div/div[1]/segment/div[2]/div/stripe/div/div/div[2]/div/div/div/div/div[3]/div/a/img"))).to.eventually.exist;
        yield delay(3000);
    }));
    ...
    Then('LPA-0050 Click on Listen audio books and Verify with parish admin', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(6000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div[2]/div/segmented-page/div/div[2]/segment/div[2]/div/stripe/div/div/div[1]/div[1]/h3"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div[2]/div/segmented-page/div/div[2]/segment/div[2]/div/stripe/div/div/div[2]/div/div/div/div/div[9]/div/a/img"))).to.eventually.exist;
        yield delay(3000);
    }));
    When('Click on Choose organization', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='co-payment-form']/fieldset")).click();
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='checkout-step-payment']/div/div[3]/div/button")).click();
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='checkout-step-payment']/div/div[3]/div/button")).click();
    ...
    Then('LPA-0050 Click on Listen espanol and Verify with parish admin', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(6000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div[2]/div/segmented-page/div/div[4]/segment/div[2]/div/stripe/div/div/div[1]/div[1]/h3"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div[2]/div/segmented-page/div/div[4]/segment/div[2]/div/stripe/div/div/div[2]/div/div/div/div/div[9]/div/a/img"))).to.eventually.exist;
        yield delay(3000);
    }));
    ...
    Then('Show products link is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products.html']"))).to.eventually.exist;
        yield delay(8000);
    }));
    ...
    Then('click on feature film link and verify', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/watch/feature-films.html']")).click();
        yield delay(20000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[3]/ol/li[1]/div/a/img"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('click on Documentreies link and verify', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(15000);
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/watch/documentaries.html']")).click();
        yield delay(20000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/h1"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('click on Talks link and verify', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/watch/talks.html']")).click();
        yield delay(20000);
    ...
    Then('click on Tv shows link and verify', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/watch/tv-shows.html']")).click();
        yield delay(20000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[3]/ol/li[3]/div/a/img"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('click on Espamol in watch link and verify', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/watch/spanish.html']")).click();
        yield delay(20000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[3]/ol/li[3]/div/a/img"))).to.eventually.exist;
        yield delay(2000);
    }));
    ...
    Then('Click on audio dramas Link and Verify', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(1000);
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/listen/audio-dramas.html']")).click();
        yield delay(20000);
    ...
    Then('Click on audiobooks Link and Verify', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/listen/audiobooks.html']")).click();
        yield delay(20000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/h1"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('Click on espanol Listen Link and Verify', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/listen/espa-ol.html']")).click();
        yield delay(20000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[3]/ol/li[1]/div/a/img"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('Click on nonfiction link and verify', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/read/nonfiction.html']")).click();
        yield delay(20000);
    ...
    Then('Click on youth link and verify', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/read/youth.html']")).click();
        yield delay(20000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[3]/ol/li[1]/div/a/img"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('Click on espanol link and verify', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/read/espa-ol.html']")).click();
        yield delay(20000);
    ...
    Then('Click on watch Link and Verify', () => __awaiter(this, void 0, void 0, function* () {
        ...
        protractor_1.element(protractor_1.by.xpath(".//*[@href='https://market.beta.formed.org/all-products/watch.html")).click();
        yield delay(20000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[3]/ol/li[1]/div/a/img"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('Click on Listen Link and Verify', () => __awaiter(this, void 0, void 0, function* () {
        ...
        protractor_1.element(protractor_1.by.xpath(".//*[@href='https://market.beta.formed.org/all-products/listen.html']")).click();
        yield delay(10000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[3]/ol/li[4]/div/a/img"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('Click on read Link and Verify', () => __awaiter(this, void 0, void 0, function* () {
        ...
        protractor_1.element(protractor_1.by.xpath(".//*[@href='https://market.beta.formed.org/all-products/read.html")).click();
        yield delay(10000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[3]/ol/li[4]/div/a/img"))).to.eventually.exist;
        yield delay(2000);
    }));
    ...
    Then('PAP-0020 Product detailed page is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[4]/div[2]/h1/span"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='product-addtocart-button']"))).to.eventually.exist;
        yield delay(3000);
    ...
    When('account is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='account-dropdown']/div/a[1]"))).to.eventually.exist;
        yield delay(3000);
    }));
    Then('PBP-0070 Click on purchase produt in library page', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[4]/div/ol/li/div/div/a/img"))).to.eventually.exist;
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[4]/div/ol/li/div/div/a/img")).click();
        yield delay(8000);
    }));
    Then('PBP-0070 Order Confirmation is displayed for Group', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(10000);
    ...
    Then('PBP-0070 Billing information are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(20000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div/div/div[3]/div[4]/div/div[1]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[1]/form/fieldset/fieldset/div/div[1]/div/input")).sendKeys("Chicago illonois");
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div/div/div[3]/div[4]/div/div[1]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[1]/form/fieldset/div[3]/div/input")).sendKeys("Chicago");
    ...
    When('PAP-0010 i navigate to listen and click on audio dramas', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@href='https://market.beta.formed.org/shop-products/listen/audio-dramas.html']")).click();
        yield delay(10000);
    }));
    Then('PAP-0010 Audio dramas page is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[3]/ol/li[4]/div/a/img"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='sorter']"))).to.eventually.exist;
        yield delay(2000);
    ...
    When('TS-0010 click on play button', () => __awaiter(this, void 0, void 0, function* () {
    ...
    Then('TS-0060 click on facebook', () => __awaiter(this, void 0, void 0, function* () {
    ...
    Then('TS-0090 click on gmail', () => __awaiter(this, void 0, void 0, function* () {
    ...
    Then('TS-0040 click on audio image', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div[2]/div/segmented-page/div/div[2]/segment/div[2]/div/stripe/div/div/div[2]/div/div/div/div/div[8]/div/a/img")).click();
        yield delay(15000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='audio']/div[1]/div/div[2]/img"))).to.eventually.exist;
        yield delay(1000);
    }));
    ...
    When('PPF-0010 i move to physical products', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.browser.actions().mouseMove(protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/physical-products.html']"))).perform();
        yield delay(5000);
    }));
    Then('PPF-0020 click on physical products', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/physical-products/dvds.html']"))).to.eventually.exist;
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/physical-products/dvds.html']")).click();
        yield delay(10000);
    }));
    ...
    Then('BiaY Payment information is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(20000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='checkout-step-payment']/div/div[3]/div/button"))).to.eventually.exist;
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='checkout-step-payment']/div/div[3]/div/button")).click();
        yield delay(15000);
    }));
    Then('ALA-0010 click on Account', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(8000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='simple-dropdown']/span")).click();
        yield delay(4000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='header']/div/div[1]/div/div/ul/profile-menu/div/div/div/div/div[2]/a[1]")).click();
        yield delay(10000);
    }));
    Then('ALA-0020 click on On Demand subscription in account page', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='account-nav']/ul/li[9]/a")).click();
        yield delay(10000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[3]/div[1]/div[2]/div[2]/div/a"))).to.eventually.exist;
        yield delay(2000);
    }));
    When('FFC-0320 click on cancel contribution', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(15000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//*[@id='cancel-ondemand-btn']"))).to.eventually.exist;
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath("//*[@id='cancel-ondemand-btn']")).click();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[3]/aside[5]/div[2]/footer/button[1]")).click();
        yield delay(10000);
    }));
    When('FFC-0320 Formed Contribution status is inactive', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(15000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='account-nav']/ul/li[10]/a")).click();
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[3]/div[1]/div/div[2]/div[2]/span[2]/span"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('ALA-0030 click Edit button in payment method', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[3]/div[1]/div[2]/div[1]/div[1]/span[2]/a")).click();
        yield delay(15000);
    }));
    Then('ALA-0040 click on change payment Method', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='md_savecard']")).click();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='md_savecard']/option[1]")).click();
        yield delay(5000);
    }));
    Then('ALA-0050 Billing information from pbc', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(15000);
        protractor_1.element(protractor_1.by.xpath("//*[@id='billing_address_firstname']")).sendKeys("Fname");
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//*[@id='billing_address_lastname']")).sendKeys("Lname");
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//*[@id='billing_address_street']")).sendKeys("chicago ilunious");
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//*[@id='billing_address_city']")).sendKeys("chicago");
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//*[@id='billing_address_region_id']")).click();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@value='12']")).click();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//*[@id='billing_address_zip']")).sendKeys("60014");
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//*[@id='billing_address_telephone']")).sendKeys("88557715158");
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//*[@id='billing_address_authorized_by']")).sendKeys("saichraaaa");
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[3]/aside[1]/div[2]/footer/button")).click();
        yield delay(15000);
    }));
    Then('ALA-0060 click on Add Cupon in On demand subscription', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='coupon-btn']")).click();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='coupon-edit-popup-container']/div/p/input")).sendKeys("testGAS");
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@class='cancel-ondemand-btn']")).click();
        yield delay(10000);
    }));
    Then('ALA-0070 click on Resend invoice', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[3]/div/div[1]/div/div[1]/span[2]/a")).click();
        yield delay(8000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div[2]/div[1]/div/div"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('FFC-0120 click on Account', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(8000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='simple-dropdown']/span")).click();
        yield delay(20000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='header']/div/div[1]/div/div/ul/profile-menu/div/div/div/div/div[2]/a[1]"))).to.eventually.exist;
    ...
    Then('FFC-0120 click on On Demand Subscription', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/formed/account/']"))).to.eventually.exist;
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/formed/account/']")).click();
        yield delay(15000);
    }));
    When('FFC-0220 click on enable button in On Demand Subscription page', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[3]/div[1]/div[2]/div[2]/div/a")).click();
        yield delay(10000);
    }));
    Then('FFC-0220 Accept Terms buton is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(10000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("html/body/div[3]/aside[4]/div[2]/footer/button[1]"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('FFC-0220 click on Accept Terms button', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(15000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[3]/aside[4]/div[2]/footer/button[1]")).click();
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("html/body/div[3]/aside[3]/div[2]/footer/button[1]"))).to.eventually.exist;
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[3]/aside[3]/div[2]/footer/button[1]")).click();
        yield delay(10000);
    }));
    When('FFC-0220 click on Enable Formed Funding', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@class='primary enable-modal-btn']")).click();
        yield delay(10000);
    }));
    When('FFC-0260 click on Cancel On-demand subscription', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='cancel-ondemand-btn']")).click();
        yield delay(10000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("html/body/div[3]/aside[5]/div[2]/footer/button[1]"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('FFC-0260 click on Cancel Subscription', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath("html/body/div[3]/aside[5]/div[2]/footer/button[1]")).click();
        yield delay(5000);
    }));
    Then('FFC-0260 Subcription was cancelled message is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div[2]/div[1]/div/div")).getText()).to.eventually.equal('Your subscription was canceled.');
        yield delay(5000);
    }));
    When('FFC-0220 Formed Funding is enable', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@class='primary enable-modal-btn']"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('FFC-0230 Formed funding Tab page is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='enableModalToggle']"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='formed-funding-history-table-export']"))).to.eventually.exist;
        yield delay(2000);
    }));
    When('FFC-0250 Disable button is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='enableModalToggle']"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('FFC-0250 click on disable button in formed funding page', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='enableModalToggle']")).click();
        yield delay(10000);
    }));
    Then('FFC-0250 click on Disable formed funding', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@class='primary enable-modal-btn']")).click();
        yield delay(7000);
    }));
    Then('FFC-0250 Campigan disable message is dispalyed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div[2]/div[1]/div/div")).getText()).to.eventually.equal('Campaign disabled successfully.');
        yield delay(5000);
    }));
    When('click on logout button in Account page', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='account-dropdown-button']")).click();
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='account-dropdown']/div/a[5]"))).to.eventually.exist;
        yield delay(3000);
    ...
    Then('FFC-0110 click on login button and enter Formed funding user details', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='login-dropdown-button']")).click();
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='gigya-login-screen']/form/div/div[1]/div[1]/input")).sendKeys("Bekkam@gmail.com");
        yield delay(1000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='gigya-login-screen']/form/div/div[1]/div[2]/input")).sendKeys("Honey@123");
        yield delay(1000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='gigya-login-screen']/form/div/div[2]/div/input[1]")).click();
    ...
    Then('FFC-0130 On Demand Subscription page is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@class='subscription-info__item-content']"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='/formed-funding/account']"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('FFC-0140 Formed Funding Tab is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/formed-funding/account/']"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('FFC-0150 Click on Formed Funding Tab', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/formed-funding/account/']")).click();
        yield delay(10000);
    }));
    Then('FFC-0160 Formed Funding page is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='appealModalToggle']"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='goalModalToggle']"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='formed-funding-history-table-export']"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('FFC-0170 click ALL dropdown', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='formed-funding-history-table-filter']")).click();
        yield delay(8000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='formed-funding-history-table-filter']/option[2]"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('FFC-0180 click on Hide button in Visisbility', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='appealModalToggle']")).click();
        yield delay(10000);
    }));
    Then('FFC-0180 Hide APPEALS button is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@class='primary appeal-modal-btn']"))).to.eventually.exist;
        yield delay(2000);
    }));
    Then('FFC-0180 click on Hide APPEALS button', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath(".//*[@class='primary appeal-modal-btn']")).click();
        yield delay(10000);
    }));
    When('FFC-0190 click on Show button in Hide', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='appealModalToggle']")).click();
        yield delay(10000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@class='primary appeal-modal-btn']"))).to.eventually.exist;
    ...
    Then('FFC-0190 click on Show APPEALS button is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@class='primary appeal-modal-btn']"))).to.eventually.exist;
        yield delay(2000);
    }));
    When('FFC-0190 click on Show APPEALS button', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath(".//*[@class='primary appeal-modal-btn']")).click();
        yield delay(10000);
    }));
    Then('FFC-0200 Formed Funding History is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='campaign_history-0']/td[2]"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='campaign_history-1']/td[2]"))).to.eventually.exist;
        yield delay(2000);
    }));
    When('FFC-0210 click on Edit in Formed funding', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='goalModalToggle']")).click();
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='goal-modal']/div/input")).click();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/aside[3]/div[2]/footer/button")).click();
        yield delay(10000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div[2]/div[1]/div/div")).getText()).to.eventually.equal('Campaign funding goal successfully changed.');
        yield delay(10000);
    }));
});
