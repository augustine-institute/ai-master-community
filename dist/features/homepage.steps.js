...
cucumber_1.defineSupportCode(function ({ Given, Then, When }) {
    ...
    Then('ABP-0010 plan details are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='account-nav']/ul/li[1]/a"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='account-nav']/ul/li[2]/a"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='account-nav']/ul/li[4]/a"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='account-nav']/ul/li[6]/a"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='account-nav']/ul/li[8]/a"))).to.eventually.exist;
        yield delay(5000);
    ...
    When('ABP-0010 account overview is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[1]/div[2]/section"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[1]/div[2]/div/p[1]"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[1]/div[2]/div/p[2]"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[1]/div[4]"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='my-orders-table']/tbody/tr[1]"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='my-orders-table']/tbody/tr[2]"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='my-orders-table']/tbody/tr[3]"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='my-orders-table']/tbody/tr[4]"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='my-orders-table']/tbody/tr[5]"))).to.eventually.exist;
        yield delay(3000);
    }));
    When('ABP-0020 click on login settings', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='account-nav']/ul/li[4]/a")).click();
        yield delay(10000);
    }));
    Then('ABP-0020 login details are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='gigya-update-profile-screen']/form/div[1]/div/div[1]/input"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='gigya-update-profile-screen']/form/div[1]/div/div[2]/input"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='gigya-update-profile-screen']/form/div[1]/div/div[3]/input"))).to.eventually.exist;
        yield delay(3000);
    ...
    Then('ABP-0030 payment method details is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='my-saved-cards-table']/tbody/tr/td[5]/span/form[1]/a"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='my-saved-cards-table']/tbody/tr/td[5]"))).to.eventually.exist;
        yield delay(3000);
        ...
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='my-saved-cards-table']/tbody/tr/td[5]/span/form[1]/a")).click();
        yield delay(10000);
    }));
    Then('ABP-0040 edit page is displayed in payment method', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='form_delete_93']/div/a"))).to.eventually.exist;
        yield delay(3000);
    ...
    When('ABP-0050 click on credit plan', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='account-nav']/ul/li[7]/a")).click();
        yield delay(10000);
    }));
    Then('ABP-0050 credit plan details are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[3]/div[2]/div/h3"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[3]/div[2]/div/p[1]/a"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[3]/div[2]/div/p[2]/a[1]"))).to.eventually.exist;
        yield delay(3000);
        ...
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[6]"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[3]/div[2]/div/p[1]"))).to.eventually.exist;
        yield delay(3000);
    ...
    Then('ABP-0050 credit plan subscription is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[1]/ul/li[3]"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[1]/ul/li[2]"))).to.eventually.exist;
        yield delay(3000);
    }));
    ...
    Then('ABP-0050 cancel credit plan prompt is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("html/body/div[5]/aside[2]/div[2]/footer/button[1]"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='plan-cancel-popup-container']"))).to.eventually.exist;
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/aside[2]/div[2]/header/button")).click();
        yield delay(10000);
    }));
    ...
    Then('ABP-0070 orders page is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='my-orders-table']/tbody/tr[1]"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[3]/div[1]/strong"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='my-orders-table']/tbody/tr[1]/td[5]/a/span"))).to.eventually.exist;
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='my-orders-table']/tbody/tr[1]/td[5]/a/span")).click();
        yield delay(10000);
    }));
    Then('ABP-0070 View details is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div[1]/div[3]/div[1]/div[1]"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div[1]/div[3]/div[1]/div[4]/div[1]/div[1]/div[2]/div[1]/img[2]"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div[1]/div[3]/div[2]/div[1]"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div[1]/div[3]/div[1]/div[4]/div[1]/div[2]/div[1]/div[2]"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div[1]/div[3]/div[1]/div[4]/div[1]/div[2]/div[2]/div[2]/span/span"))).to.eventually.exist;
        yield delay(3000);
    }));
    ...
    Then('PAP-0020 Product detailed page is displayed', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='options-803-list']/div/label"))).to.eventually.exist;
        yield delay(3000);
    ...
    Then('PAP-0020 Text, You May Also Like, Product card in right column with image, Add to cart button are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='related__items']/div[2]/div/ol/li[1]/div/a"))).to.eventually.exist;
        yield delay(3000);
    ...
    When('PBP-0060 click on incart icon', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@class='action showcart']")).click();
        yield delay(6000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='mini-cart']/li/div[1]/span/img"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='mini-cart']/li[1]/div[1]/div/div"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='mini-cart']/li[1]/div[1]/div/strong[2]"))).to.eventually.exist;
        yield delay(3000);
    }));
    ...
    When('PBP-0050 click on product in you may also like', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='related__items']/div[2]/div/ol/li[2]/div/a/img")).click();
        yield delay(5000);
    }));
    When('PBP-0060 click on remove option', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='mini-cart']/li[1]/div[1]/div/div/div/a")).click();
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='minicart-content-wrapper']/div"))).to.eventually.exist;
        yield delay(3000);
    }));
    When('PBP-0060 Click on check out option', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='top-cart-btn-checkout']")).click();
        yield delay(15000);
    }));
    When('PBP-0070 Click on the create an account', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
    ...
    Then('PBP-0070 Click on View library', () => __awaiter(this, void 0, void 0, function* () {
    ...
    Then('PBP-0070 Order Confirmation is displayed for Group', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div[1]/div[4]/div[1]/div[1]/div[2]/div[2]/strong"))).to.eventually.exist;
    ...
    When('VR-0020 Click on the create an account', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@class='action action-register primary modaltrigger']")).click();
        yield delay(10000);
    }));
    ...
    Then('CPS-0080 Order Confirmation is displayed', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div/div[4]/div[1]/div[1]/div[2]/div[2]/strong"))).to.eventually.exist;
        yield delay(10000);
    }));
    ...
    Then('CPS-0020 Get Credit Plan prompt is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[5]/div[1]/div[2]/div[3]/div/span/button"))).to.eventually.exist;
        //element(by.xpath("html/body/header/section[1]/div[8]/div/a/span")).isDisplayed();
    }));
    When('CPS-0030 i click on get credits plan', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[5]/div[1]/div[2]/div[3]/div/span/button")).click();
        yield delay(10000);
    }));
    ...
    When('then account is displayed', () => __awaiter(this, void 0, void 0, function* () {
    ...
    When('HPF-0020 move to shop products', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.browser.actions().mouseMove(protractor_1.element(protractor_1.by.xpath("html/body/header/section[2]/section/div[1]/div[1]/a/span[1]"))).perform();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/watch.html']")).click();
        yield delay(2000);
        ...
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/listen.html']"))).to.eventually.exist;
        yield delay(2000);
        ...
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/formed-subscriptions.html']"))).to.eventually.exist;
        yield delay(2000);
    ...
    When('HPF-0050 i click on library link', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(20000);
        protractor_1.element(protractor_1.by.xpath(".//*[@href='https://market.beta.formed.org/mylibrary/']']")).click();
        yield delay(15000);
    }));
    Then('your library is  empty and some message is displayed', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/section/p"))).to.eventually.exist;
        yield delay(2000);
    ...
    When('HPF-0080 show purchase products', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li/ol/li[2]/a/label/div[1]"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li/ol/li[3]/a/label/div[2]"))).to.eventually.exist;
        yield delay(3000);
    }));
    ...
    Then('LLP-0010 Formed icon, Ondemand, Library, Market are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(15000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@href='https://beta.formed.org/']"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@href='https://beta.formed.org//community']"))).to.eventually.exist;
        yield delay(3000);
    ...
    Then('LLP-0080 Subscription, Parish, Payment information are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield delay(8000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div/div[1]/div[1]/div/div/div/div[3]/div[2]/modal-link/a/span"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='parishCode']"))).to.eventually.exist;
        yield delay(2000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='scroll-top']/div/div/div[1]/div[1]/div/div/div/div[3]/div[2]/subscription-cancel/modal-link/a/span"))).to.eventually.exist;
        yield delay(2000);
    }));
    ...
    When('PBC-0010 click on pay by check', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='checkout-payment-method-load']/div/div[1]/div[2]/div/div/select")).click();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='checkout-payment-method-load']/div/div[1]/div[2]/div/div/select/option[2]")).click();
        yield delay(10000);
    }));
    Then('PBC-0020 Billing information are displayed', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div[3]/div/div[3]/div[5]/ol/li[5]/div/form/fieldset/div[1]/div/div[2]/div[2]/div[2]/div[2]/div/input")).sendKeys("Hulk");
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div[3]/div/div[3]/div[5]/ol/li[5]/div/form/fieldset/div[1]/div/div[2]/div[2]/div[2]/div[3]/div/fieldset/div[2]/form/div/fieldset/div/div[1]/div/input")).sendKeys("Chicago illonois");
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div[3]/div/div[3]/div[5]/ol/li[5]/div/form/fieldset/div[1]/div/div[2]/div[2]/div[2]/div[3]/div/fieldset/div[2]/form/div/div[4]/div/input")).sendKeys("Chicago");
        yield delay(1000);
        protractor_1.element(protractor_1.by.css("html/body/main/div/main/div[3]/div/div[3]/div[5]/ol/li[5]/div/form/fieldset/div[1]/div/div[2]/div[2]/div[2]/div[3]/div/fieldset/div[2]/form/div/div[5]/div/select")).click();
        yield delay(1000);
        ...
        yield delay(1000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div[3]/div/div[3]/div[5]/ol/li[5]/div/form/fieldset/div[1]/div/div[2]/div[2]/div[2]/div[3]/div/fieldset/div[2]/form/div/div[9]/div/input")).sendKeys("9898985555");
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath("html/body/main/div/main/div[3]/div/div[3]/div[5]/ol/li[5]/div/form/fieldset/div[1]/div/div[2]/div[2]/div[2]/div[3]/div/fieldset/div[2]/form/div/div[7]/div/input")).sendKeys("60014");
        yield delay(1000);
    ...
    When('VR-0060 Enter organization information', () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield delay(2000);
        protractor_1.element(protractor_1.by.xpath(".//*[@class='btn btn-primary btn-large']")).click();
        yield delay(5000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/group-finish-init/div[2]/div[2]/div/div/p/button")).click();
        yield delay(10000);
    }));
    ...
    Then('PBP-0010 click on Read option in digital products', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.browser.actions().mouseMove(protractor_1.element(protractor_1.by.xpath(".//*[@href='https://market.beta.formed.org/shop-products.html']"))).perform();
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/read.html']"))).to.eventually.exist;
        yield delay(3000);
    ...
    Then('PBP-0010 Read Products page is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/read/nonfiction.html']"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/read/fiction.html']"))).to.eventually.exist;
        yield delay(3000);
    ...
    When('PBP-0020 click on the read product', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[3]/ol/li[1]/div/a/img")).click();
        yield delay(10000);
    }));
    Then('PBP-0020 Read Products page are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[5]/div[1]/div[1]/div/img"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='product__description']/div[1]/p[1]"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='related__items']"))).to.eventually.exist;
        yield delay(5000);
    }));
    ...
    Then('SPP-0030 Search product page is displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div/section[1]/a/div/h2"))).to.eventually.exist;
        yield delay(3000);
        ...
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[1]/ol/li[3]/div/div/div[1]/div[3]/span"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[2]/ol"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dt[4]"))).to.eventually.exist;
        yield delay(3000);
    }));
    ...
    Then('SPP-0040 Watch sub options are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[2]/ol/li[1]/ol/li[1]/a/label/div"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[2]/ol/li[1]/ol/li[2]/a/label/div"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[2]/ol/li[1]/ol/li[3]/a/label/div"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[2]/ol/li[1]/ol/li[4]/a/label/div"))).to.eventually.exist;
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[2]/ol/li[2]/a/label/div")).click();
        yield delay(15000);
    }));
    Then('SPP-0040 Listen sub options are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[2]/ol/li[2]/ol/li[1]/a/label/div"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[2]/ol/li[2]/ol/li[2]/a/label/div"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[2]/ol/li[2]/ol/li[3]/a/label/div"))).to.eventually.exist;
        yield delay(3000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[2]/ol/li[3]/a/label/div")).click();
        yield delay(15000);
    }));
    Then('SPP-0040 Read sub options are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[2]/ol/li[3]/ol/li[2]/a/label"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[2]/ol/li[3]/ol/li[3]/a/label/div"))).to.eventually.exist;
        yield delay(3000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[2]/ol/li[3]/ol/li[4]/a/label/div"))).to.eventually.exist;
        yield delay(3000);
    }));
    When('SPP-0040 select one or more attribute filter', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[4]/ol/form/li[5]/a/label/div")).click();
        yield delay(6000);
        protractor_1.element(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[4]/ol/form/li[6]/a/label/div")).click();
        yield delay(6000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[1]/ol/li[2]/div/a"))).to.eventually.exist;
        yield delay(3000);
    }));
    When('SPP-0050 click on filter product', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[1]/ol/li[2]/div/a")).click();
        yield delay(10000);
    }));
    Then('SPP-0050 Product details are displayed', () => __awaiter(this, void 0, void 0, function* () {
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='maincontent']/div[2]/div/div[5]/div[1]/div[1]/div[1]/img"))).to.eventually.exist;
        yield delay(3000);
    ...
    Then('SPP-0060 Product page is displayed', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@href='https://market.beta.formed.org/shop-products/read/fiction.html']")).click();
        yield delay(10000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[3]/ol/li[1]/div/a/img"))).to.eventually.exist;
        yield delay(5000);
        yield hooks_1.expect(protractor_1.browser.findElement(protractor_1.by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[2]/ol/li[3]/a/label/div"))).to.eventually.exist;
        yield delay(5000);
    ...
    When('SPP-0080 Click second', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath(".//*[@id='amasty-shopby-product-list']/div[3]/ol/li[2]/div/a/img")).click();
        yield delay(5000);
    }));
    ...
    Then('click on Talks link and verify', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath("//a[@href='https://market.beta.formed.org/shop-products/watch/talks.html']")).click();
        yield delay(10000);
    ...
    Then('close the share icons', () => __awaiter(this, void 0, void 0, function* () {
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/topic-share/div[1]/div/div/i")).click();
        yield delay(10000);
        protractor_1.element(protractor_1.by.xpath("html/body/div[5]/div/div/topic-share/div[1]/div/i")).click();
        yield delay(10000);
    }));
